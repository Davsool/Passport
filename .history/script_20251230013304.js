...
// ... (Mantenha todo o código anterior até a Seção 8) ...
...
if (avatarContainer && userMenu) {
    ...
    avatarContainer.addEventListener('click', (e) => {
        e.stopPropagation(); // Impede que o clique vá para a janela (que fecharia o menu)
        userMenu.classList.toggle('active');
    });

    // 2. CORREÇÃO: Ao clicar NO MENU -> Não faz nada (não fecha)
    userMenu.addEventListener('click', (e) => {
        e.stopPropagation(); // Impede que o clique suba para a foto
    });
